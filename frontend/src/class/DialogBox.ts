export type DialogBoxConfig = {
  ...
  export class DialogBox extends Phaser.GameObjects.Container {
    ...
    constructor(public scene: Phaser.Scene, { x, y, width, height, padding=10, margin=10, textStyle={} }: DialogBoxConfig) {
      ...
      this.box = new Phaser.GameObjects. Rectangle(this.scene, x, y, width, height, 0xEDDFCE).setStrokeStyle(1, 0x663300);
      ...
      this.actorNameBox = new Phaser.GameObjects.Rectangle(this.scene, x - width/2, y - height/2 - margin, 0, 40, 0xEDDFCE).setStrokeStyle(1, 0xffffff);
