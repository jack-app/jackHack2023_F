...
//stage1
  stage1:[
    {type: 'setBackground', x: 400, y: 300, key: 'street',scaleX: 1.7, scaleY: 1.7},
    {type: 'dialog', text: '-1st stage- \n ロマン人（ちゅ）はロマン人（ちゅ）のなすようにせよ ▼'},
    // 出来れば音楽変更
    {type: 'addForeground', x: 120, y: 300, key: 'actor1',scaleX: 0.5, scaleY: 0.5},
    ...
    {type: 'addForeground', x: 600, y: 300, key: 'hina',scaleX: 0.8, scaleY: 0.8},
...
//stage2
    stage2: [
        {type: 'setBackground', x: 400, y: 300, key: 'school',scaleX: 1 ,scaleY: 1.5},
        {type: 'dialog', text: '-2nd stage-  \n 全ての道はロマンに通ず ▼'},
        // 出来るなら曲を変更する
        {type: 'addForeground', x: 120, y: 300, key: 'actor2',scaleX: 0.5, scaleY: 0.5},
        {type: 'dialog', text: ' 全ての道はロマンに通ず！ ▼', actorName:actor},
        {type: 'dialog', text: 'なんでついてくるんだよ… ▼', actorName:'あなた'},
        {type: 'dialog', text: 'ぷすー(おならの音)  ▼'},
        {type: 'addForeground', x: 430, y: 330, key: 'hina2',scaleX: 0.8, scaleY: 0.8},
    ...
    stage3: [
        {type: 'setBackground', x: 400, y: 300, key: 'star',scaleX: 1.3, scaleY: 1.4},
        ...
        {type: 'addForeground', x: 120, y: 300, key: 'actor3',scaleX: 0.5, scaleY: 0.5},
        {type: 'dialog', text: 'なにきょどきょどしてんのよ！今がパーフェクトおロマンティックチャンスよ！？星空に関して何かロマンティックなことを言いなさい！ ▼', actorName:actor},
        // ここでプレイヤーが入力
        {type: 'dialog', text: 'プレイヤーが入力  ▼', actorName:'あなた'},
        // 判定結果を返す
        {type: 'dialog', text: '採点結果を返す ▼', actorName:actor},
        {type: 'dialog', text: 'これでロマンティック講座はおしまいよ！\n あなたは少しでもおロマンティック人に近づけたかしら！！ ▼', actorName:actor},
